...
async function getTokenAirdroppedAmount(index) {
    try {
        // Call the automatically generated getter for the mapping
        const value = await contract.tokenAirdroppedAmount(index);
        console.log('Value at index', index, 'is:', value.toString());
...
module.exports = getTokenAirdroppedAmount;
